...
interface NumericVector<E> : Vector<E> where E : Number { // todo once algebraic data types are in, change type constraint
    // Properties
...
interface MutableNumericVector<E> : NumericVector<E>, MutableVector<E> where E : Number { // todo once algebraic data types are in, change type constraint
...
fun <T> vectorOf(vararg elements: T): Vector<T> = TODO()

fun <T> mutableVectorOf(): MutableVector<T> = TODO()

fun <T> mutableVectorOf(vararg elements: T): MutableVector<T> = TODO()

fun <T : Any> vectorOfNotNull(vararg elements: T?): Vector<T> = TODO()

@Suppress("FunctionName")
inline fun <T> Vector(size: Int, init: (index: Int) -> T): Vector<T> = MutableVector(size, init)

@Suppress("FunctionName")
inline fun <T> MutableVector(size: Int, init: (index: Int) -> T): MutableVector<T> = TODO()

//-----------------------------------------------------Extensions-----------------------------------------------------//

fun <T> Collection<T>.toVector(): Vector<T> = TODO("Not Implemented")
